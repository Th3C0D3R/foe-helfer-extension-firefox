		...
		if (rd.length > 0) {
			...
			for (let i in rd) {
				if (rd.hasOwnProperty(i)) {
					...
					h.push('<td><span class="show-entity" data-id="' + rd[i]['id'] + '"><img class="game-cursor" src="moz-extension://' + extID + '/css/images/eye-open.svg"></span></td>');
					h.push('</tr>');
				}
			}
		...
		if (wk.length > 0) {
			...
			for (let i in wk) {
				if (wk.hasOwnProperty(i)) {
					...
					h.push('<td><span class="show-entity" data-id="' + wk[i]['id'] + '"><img class="game-cursor" src="moz-extension://' + extID + '/css/images/eye-open.svg"></span></td>');
					h.push('</tr>');
				}
			}
